...
export default function Invoice_Sales() {
  ...
  return (
    <>
      <h1 className="mb-4 p-4 font-extrabold text-2xl text-center rounded bg-zinc-900/80">Invoicing & Sales</h1>
      ...
      <form className="p-6 flex flex-col font-bold rounded bg-zinc-900/80" onSubmit={onSubmit}>
        ...
        <div className="mb-6 grid gap-y-2">
          ...
          <input className="px-3 py-2 rounded font-medium bg-zinc-700/50" type="text" name="item" />
        </div>
      ...
      <div className="mt-4 p-6 flex flex-col items-end font-bold rounded bg-zinc-900/80">
        ...
        <table className="table w-full rounded-md rounded-tr-none border-4 border-spacing-1 border-separate border-zinc-600">
