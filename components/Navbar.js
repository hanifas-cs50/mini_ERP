export default function Navbar() {
  return (
    <nav className="fixed w-full max-w-screen-xl mx-auto z-50">
      <div className="relative h-16 px-4 ml-72 flex items-center justify-between bg-zinc-900 border-r-4 border-zinc-600">
        <button type="button" className="p-1 rounded hover:bg-zinc-700/50">
        ...
        <button type="button" className="p-2 flex items-center gap-1 font-bold rounded-md hover:bg-zinc-700/50">
          @User9019
        ...
        <div className="absolute right-4 top-[4.5rem] rounded bg-zinc-900">
